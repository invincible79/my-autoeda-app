...
st.set_page_config(page_icon="📊", page_title="AutoEDA : Automated Exploratory Data Analysis")

# Custom CSS for a minimalist and professional look
st.markdown("""
    <style>
    .stApp {
...
st.sidebar.title("AutoEDA: Automated Exploratory Data Analysis")
